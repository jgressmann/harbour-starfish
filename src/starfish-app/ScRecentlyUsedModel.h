...
public:
    ...
    QStringList rowIdentifierColumns() const { return m_RowIdentifierColumns; }
    ...
    Q_INVOKABLE void add(const QList<QVariant>& values);
...
private:
    ...
    bool createTable();
    void tryGetReady();
    bool writeBackCache() const;
    void setColumnBasedSql();

private:
    QStringList m_ColumnNames, m_ColumnTypes, m_RowIdentifierColumns;
//    QVector<QVariant> m_RowModified;
    mutable QVector<QVariant> m_RowCache;
    QHash<int,QByteArray> m_RoleNames;
    QString m_Table;
    QString m_RowCountSql;
    QString m_SelectDataSql;
    QString m_SelectOldestRowSql;
    QString m_DeleteRowSql;
//    QString m_UpdateModifiedSql;
    ...
    int m_Count;
    int m_RowCount;
//    mutable int m_IndexSelected;
    mutable int m_IndexCache;
//    bool m_NeedToCreateTable;
    bool m_Ready;
